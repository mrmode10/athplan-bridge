...
var PORT = 3000;
var URL = "http://localhost:".concat(PORT, "/stripe-webhook");
function simulateStripeWebhook() {
    return __awaiter(this, void 0, void 0, function () {
        var event, response, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, axios_1.default.post(URL, event, {
                ...
                case 3:
                    ...
                    if (error_1.response) {
                        ...
                        console.error('❌ Error Data:', error_1.response.data);
                    }
                    else {
